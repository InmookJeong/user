...
<main class="d-flex justify-content-center mt-6">
	<section class="h-35rem text-center">
		...
		<form class="box w-20rem h-15rem p2 login-form">
			...
			<table class="w-100p">
				<tr>
					<td class="menu-link w-33p cursor-pointer font-bold-hover" data-btn-name="find-id" onclick="findId()">아이디 찾기</td>
					<td class="menu-link w-33p cursor-pointer font-bold-hover" data-btn-name="find-password" onclick="findPassword()">비밀번호 찾기</td>
					<td class="menu-link w-33p cursor-pointer font-bold-hover" data-btn-name="sign-up" onclick="signUp()">회원가입</td>
				</tr>
			</table>
		</form>
	</section>
